...
router.get('/all-jobs', requireAuth, requireAdmin, jobPostController.getAllJobPosts);

// Admin-only: Approve job post
router.put('/approve-job/:id', requireAuth, requireAdmin, jobPostController.approveJobPost);

// Admin-only: Update job post
router.put('/update-job/:id', requireAuth, requireAdmin, jobPostController.updateJobPost);

// Admin-only: Delete job post
router.delete('/delete-job/:id', requireAuth, requireAdmin, jobPostController.deleteJobPost);
